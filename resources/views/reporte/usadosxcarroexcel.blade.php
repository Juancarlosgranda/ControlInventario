...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" >
	...
	<table>
				...
				<tr bgcolor="#E4E2E2" rowspan=9>
					<td style="vertical-align: middle; text-align:left;" colspan="6"><font size='4' color='#000'><strong>El uso de repuestos entre las fechas:</strong>{{$fechas}}</font></td> 
					
				</tr>
				
			</table>
	<table border=\"1\" align=\"center\">
		<font size='6' color='#084B8A'><center><strong>Vehículo:</strong>{{$carro}}</center></font>
				...
				@foreach ($registros as $registro)
                    ...
                    @endforeach
                    <tr>
                       <td colspan="3"><font size='4' color='#084B8A'><center>TOTAL DE GASTOS</center></font></td><td><font size='4' color='#084B8A'><center>{{$gastosRe}} S/.</center></font></td>
                       <td></td>
...
<?php
	...
	header("Content-Disposition: attachment; filename=GastosporCarro.xls");  
