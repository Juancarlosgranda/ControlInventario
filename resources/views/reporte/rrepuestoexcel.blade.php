...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" >
	...
	<table>
				...
				<tr bgcolor="#E4E2E2" rowspan=9>
					<td colspan="7"><font size='6' color='#000'><center>H&C TRANSPORTE. HERNAN COLLADO BLANCO. S.R.L</center></font></td>
					
				</tr>
				<tr bgcolor="#E4E2E2" rowspan=9>
					<td style="vertical-align: middle; text-align:left;" colspan="7"><font size='4' color='#000'><strong></strong>{{$nota}}</font></td> 
	...
	<table border=\"1\" align=\"center\">
				...
				@foreach ($registros as $registro)
					...
					<tr>
						...
						<td style="mso-number-format:'#,##0.00;-#,##0.00';vertical-align: middle; text-align:center;">{{$registro->precio}} S/.</td>
						<td style="vertical-align: middle; text-align:center;">{{$registro->fecha}}</td>
						<td style="vertical-align: middle; text-align:center;">{{$registro->placa}}</td>
						<td style="vertical-align: middle; text-align:center;">{{$registro->sede->nombre}}</td>
						<td style="mso-number-format:'#,##0.00;-#,##0.00';vertical-align: middle; text-align:center;">{{$registro->costo}} S/.</td>
					</tr>
                    @endforeach
			</table>
</html>
...
<?php
	...
	header("Content-Disposition: attachment; filename=Repuestos.xls");  
